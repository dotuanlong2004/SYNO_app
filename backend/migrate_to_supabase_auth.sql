...
-- From custom auth to Supabase Native Auth
-- ============================================================
...
-- 2. Update students table - change parent_id to UUID
ALTER TABLE students ALTER COLUMN parent_id TYPE UUID USING parent_id::text::UUID;

-- 3. Update attendance_logs created_by to UUID
ALTER TABLE attendance_logs ALTER COLUMN created_by TYPE UUID USING created_by::text::UUID;

-- 4. Update timetables created_by to UUID
ALTER TABLE timetables ALTER COLUMN created_by TYPE UUID USING created_by::text::UUID;
...
-- 6. Update RLS policies for students
...
-- 7. Drop old tables (optional - after migration)
